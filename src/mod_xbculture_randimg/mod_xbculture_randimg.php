...
/*******
 * @package xbCulture
 * @filesource mod_xbculture_randimg/mod_xbculture_randimg.php
 * @version 0.2.0 28th October 2022
 * @since 0.1.0 5th May 2021
 * @author Roger C-O
...
$items = modXbcultureRandimgHelper::getitems( $params );

$document	= Factory::getDocument();
$document->addStyleSheet(JURI::base(true).'/media/com_xbpeople/css/xbculture.css');
require( JModuleHelper::getLayoutPath( 'mod_xbculture_randimg' ));
